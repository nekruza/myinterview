...
export const HintOverlay: FC<HintOverlayProps> = ({ hint, onDismiss }) => {
  ...
  return (
    <div className="absolute bottom-4 left-1/2 -translate-x-1/2 z-20 animate-hint-enter">
      <div className="flex items-start gap-3 px-5 py-4 rounded-2xl bg-black/70 backdrop-blur-xl border border-[#2dec29]/30 max-w-md shadow-lg shadow-[#2dec29]/10">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-sm text-white/90 leading-relaxed">{hint}</p>
        </div>
        <button
          onClick={onDismiss}
